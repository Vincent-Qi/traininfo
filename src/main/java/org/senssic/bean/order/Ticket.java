...
public class Ticket {
	private StationDTO stationTrainDTO;
	private PaserDTO passengerDTO;
	...
	public StationDTO getStationTrainDTO() {
		return stationTrainDTO;
	}

	public void setStationTrainDTO(StationDTO stationTrainDTO) {
		this.stationTrainDTO = stationTrainDTO;
	}

	public PaserDTO getPassengerDTO() {
		return passengerDTO;
	}

	public void setPassengerDTO(PaserDTO passengerDTO) {
